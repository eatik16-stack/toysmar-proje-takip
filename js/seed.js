...
export const QUOTE_STEP_MAP = [
  ...
  { match: /(?=.*\b250\b)(?=.*(kayan|[ıi][şs][ıi]kl[ıi]))/i, step: "sa-isikli-250" },
  { match: /(?=.*\b150\b)(?=.*(kayan|[ıi][şs][ıi]kl[ıi]))/i, step: "sa-isikli-150" },
  { match: /(?=.*\b100\b)(?=.*(kayan|[ıi][şs][ıi]kl[ıi]))/i, step: "sa-isikli-100" },
